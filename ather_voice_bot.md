...
[ tool call ] call tool: check_home_test( insert the value of {{.user_pincode}} in this function )
Store the result of this tool call in {{.is_home_test_available}}
After receiving the tool call response:
IF {{.is_home_test_available}} is 1 (home test available): STRICTLY GO TO STEP 7.2.
IF {{.is_home_test_available}} is 0 (home test NOT available): STRICTLY GO TO STEP 7.
NOTE: DO NOT go directly to STEP 7 without making this mandatory check_home_test tool call.
